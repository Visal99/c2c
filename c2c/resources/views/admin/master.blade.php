...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>C</b>2C</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>C2C</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{url('storage',Auth::user()->profile)}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{url('storage',Auth::user()->profile)}}" class="img-circle" alt="User Image">
      ...
      <div class="@yield('col-size')">
         <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa @yield('boxicon')"></i>  @yield('boxtitle')</h3>
                  @yield('block-btn-right')
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                @yield('content')
